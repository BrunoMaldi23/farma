...
if ($LASTEXITCODE -ne 0) {
    Write-Host ""
    Write-Host "El build encontró errores. Envíame TODA la salida." -ForegroundColor Red
    exit $LASTEXITCODE
}

Write-Host ""
Write-Host "==================================================" -ForegroundColor Green
Write-Host " SIDEBAR + TOPBAR REDISEÑADOS Y BUILD CORRECTO" -ForegroundColor Green
Write-Host "==================================================" -ForegroundColor Green
Write-Host ""
